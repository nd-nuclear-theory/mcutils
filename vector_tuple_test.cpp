...
int main(int argc, char **argv)
{
  ...
  // VectorTuple tests
  mcutils::VectorTuple<int,3> z1;
  z1[0] = 1; z1[1] = 2; z1[2] = 3;
  cout << z1[0] << z1[1] << z1[2] << endl;
  mcutils::VectorTuple<int,3> z2(5);
  cout << z2[0] << endl;

  mcutils::VectorTuple<HalfInt,3> v1(HalfInt(1,2));
  mcutils::VectorTuple<HalfInt,3> v3(HalfInt(3,2));
  mcutils::VectorTuple<HalfInt,3> vs;
  cout << v1[0] << endl;
  vs = +v1;
  cout << vs[0] << endl;
  vs = -v1;
  ...
  mcutils::VectorTuple<int,3,1> z3;
  ...
  cout << z3 << endl;
  cout << v1 << endl;
  mcutils::VectorTuple<HalfInt,3>::SetDelimiters("< "," : "," >");
  cout << v1 << endl;
